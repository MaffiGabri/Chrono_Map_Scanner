...
import com.example.chronomapscanner.ui.BackgroundVariantUiModel
...
class BodyMapViewModelTest {
    ...
    fun setup() {
        ...
        val defaultVariants = listOf(
            com.example.chronomapscanner.data.local.room.BackgroundVariantEntity("front", "cat1", "Front", null, 0, LocalDate.now(), null),
            com.example.chronomapscanner.data.local.room.BackgroundVariantEntity("back", "cat1", "Back", null, 1, LocalDate.now(), null)
        )
        ...
        every { backgroundRepository.getCategoriesForProfile(any()) } returns flowOf(
            listOf(com.example.chronomapscanner.data.local.room.BackgroundCategoryEntity("cat1", "Default", "Profile", true))
        )
