...
@HiltAndroidApp
class ChronoMapScannerApplication : Application(), Configuration.Provider {
    ...
    override fun onCreate() {
        ...
        val request = androidx.work.PeriodicWorkRequestBuilder<com.example.chronomapscanner.data.repository.DataIntegrityWorker>(
