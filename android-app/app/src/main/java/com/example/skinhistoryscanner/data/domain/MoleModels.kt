...
import com.example.skinhistoryscanner.data.local.room.HistoryEntryEntity
import com.example.skinhistoryscanner.data.local.room.MoleEntity
import com.example.skinhistoryscanner.data.local.room.MoleWithHistory
...
fun com.example.skinhistoryscanner.data.local.room.MoleMapDto.toDomain(): MoleMapItem = MoleMapItem(
    id = id,
    x = x,
    y = y,
    side = variantId,
